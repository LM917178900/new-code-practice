...
//            BaseFont bfChinese = BaseFont.createFont("STSong-Light", "UniGB-UCS2-H", BaseFont.NOT_EMBEDDED);
            titlefont = FontFactory.getFont(FontFactory.TIMES_ROMAN, 12, Font.NORMAL, new BaseColor(34, 34, 34));
            headfont = FontFactory.getFont(FontFactory.TIMES_ROMAN, 12, Font.NORMAL, new BaseColor(34, 34, 34));
            keyfont = FontFactory.getFont(FontFactory.TIMES_ROMAN, 12, Font.NORMAL, new BaseColor(34, 34, 34));
            textfont = FontFactory.getFont(FontFactory.TIMES_ROMAN, 12, Font.NORMAL, new BaseColor(34, 34, 34));
    ...
    public void generatePDF(Document document) throws Exception {
        ...
        // 表格
        PdfPTable table = createTable(new float[]{40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40, 40});
...
public void appendDataToDocumentTest(Document document) {
    try {
        //第3步,向文档添加文字. 文档由段组成
        document.add(new Paragraph("Hello World"));
        document.add(new Paragraph("Hello World"));
        document.add(new Paragraph("Hello World"));
        document.add(new Paragraph("split _"));
        document.add(new Paragraph("中文 not allow"));
        document.add(new Paragraph("not allow 中文"));
        ...
        cellHeader.addElement(new Paragraph("table title"));
        table.addCell(cellHeader);

        for (int i = 0; i < 12; i++) {
            PdfPCell cellBody = new PdfPCell();
            cellBody.addElement(new Paragraph("table content_" + i));
